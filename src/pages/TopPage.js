...
const TopPage = () => {
    ...
    return (<div className="TopPage-container">
      {/* ハンバーガーメニュー */}
      <HamburgerMenu />
      <Header />
      ...
      {/* 各セクション */}
      <div className={isMobile ? "scroll-container mobile" : "scroll-container desktop"}>
        {isMobile ? (
        // スマホ用レイアウト
        ...
        <div className="scroll-container">
            <div className="scroll-content">
              <Link to="/dogrun">
                <img src={dogrunNameTag} alt="ドッグランネームタグ" className="item-nametag"/>
                <img src={DogrunImage} alt="ドッグランのイラスト" className="item"/>
              </Link>
              <Link to="/dogcafe">
                <img src={dogCafeNameTag} alt="ドッグカフェネームタグ" className="item-nametag"/>
                <img src={dogcafeImage} alt="ドッグカフェのイラスト" className="item"/>
              </Link>
              <Link to="/petshop">
                <img src={petshopNameTag} alt="ペットショップネームタグ" className="item-nametag"/>
                <img src={petshopImage} alt="ペットショップのイラスト" className="item"/>
              </Link>
              <Link to="/hospital">
                <img src={hospitalNameTag} alt="病院ネームタグ" className="item-hospital-nametag"/>
                <img src={hospitalImage} alt="病院のイラスト" className="hospital-item"/>
              </Link>
            </div>
            <div className="scroll-content">
              <Link to="/dogrun">
