    ...
    return (<>
      <div className="mypage-container">
        ...
        <form className="profile-update-form" onSubmit={(e) => {
          ...
          <label>
            ユーザ名の変更
            <input type="text" placeholder="新しいユーザー名を入力" value={formUserName} onChange={(e) => setFormUserName(e.target.value)} className="text-input"/>
          </label>
          <label>
            メールアドレスの変更:
            <input type="email" placeholder="メールアドレスを入力" value={formEmail} onChange={(e) => setFormEmail(e.target.value)} className="email-input"/>
          </label>

          <label>
            パスワードの変更
            <input type="password" placeholder="新しいパスワードを入力" onChange={(e) => setPassword(e.target.value)}/>
          </label>
